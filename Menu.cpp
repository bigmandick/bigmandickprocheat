...
void skeetWindow::Setup()
{
	...
	HitscanTab.RegisterControl(&SaveButton);
	HitscanTab.RegisterControl(&ConfigBox);
	HitscanTab.RegisterControl(&LoadButton);
	HitscanTab.RegisterControl(&UnloadButton);
}
...
void CRageBotTab::Setup( )
{
	...
	AimbotMode.AddItem( XorStr( "Client-Side" ) );
	AimbotMode.AddItem( XorStr( "Server-Side" ) );
	...
	AimbotGroup.PlaceLabledControl( 1, XorStr( "Target selection" ), this, &TargetSelection );
	...
	AimbotGroup.PlaceLabledControl(2, XorStr("Multi-point"), this, &Pointscale);
	...
	//Resolver
	ResolverOptions.SetText( XorStr( "Other" ) );
	...
	ResolverOptions.PlaceLabledControl(2, XorStr("Quick stop + slide"), this, &Autostop);
	...
	ResolverOptions.PlaceLabledControl( 0, XorStr( "Overide resolver" ), this, &ResolverOverride );
...
void CLegitTab::Setup()
{
	...
	pistol.AimbotMode.AddItem(XorStr("Client-Side"));
	pistol.AimbotMode.AddItem(XorStr("Server-Side"));
	...
	smg.AimbotMode.AddItem(XorStr("Client-Side"));
	smg.AimbotMode.AddItem(XorStr("Server-Side"));
	...
	rifle.AimbotMode.AddItem(XorStr("Client-Side"));
	rifle.AimbotMode.AddItem(XorStr("Server-Side"));
	...
	shotgun.AimbotMode.AddItem(XorStr("Client-Side"));
	shotgun.AimbotMode.AddItem(XorStr("Server-Side"));
	...
	sniper.AimbotMode.AddItem(XorStr("Client-Side"));
	sniper.AimbotMode.AddItem(XorStr("Server-Side"));
...
void CVisualTab::Setup()
{
	...
	PlayerESP.PlaceLabledControl(2, XorStr("Name"), this, &player.ShowPlayerNames);
	...
	OtherESP.PlaceLabledControl(0, XorStr("Bomb"), this, &DroppedC4);
	...
	OtherESP.PlaceLabledControl(0, XorStr("Hit marker"), this, &Hitmarkers);
	...
	OtherESP.PlaceLabledControl(0, XorStr("Recoil indicator"), this, &SpreadCrosshair);
...
void CPlayersTab::Setup()
{
	...
	PlayerSettingsGroup.PlaceLabledControl(0, XorStr("High priority"), this, &PlayerPriority);
	PlayerSettingsGroup.PlaceLabledControl(0, XorStr("Add to whitelist"), this, &PlayerFriendly);
