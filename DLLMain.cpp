...
void initialize_configs_file() {
	...
	create_folder("simplerealistic");

	if (!is_file_exist("simplerealistic\\simplerealisticwantstocomeinyourpcbtwthisisaratyourpcisrattednowhahah.txt")) {
		std::ofstream("simplerealistic\\simplerealisticwantstocomeinyourpcbtwthisisaratyourpcisrattednowhahah.txt");
	}
}
